...
class FID():
    ...
    def  __call__(self, images, gt_path):
        ...
        m1, s1 = self.compute_statistics_of_path(gt_path)
        print('calculate generated_images statistics...')
        m2, s2 = self.calculate_activation_statistics(images)
    ...
    def compute_statistics_of_path(self, path):
        ...
        if os.path.exists(npz_file):
            ...
            m, s = self.calculate_activation_statistics(imgs)
            np.savez(npz_file, mu=m, sigma=s)

        return m, s    

    def calculate_activation_statistics(self, images, verbose=False):
        ...
        -- sigma : The covariance matrix of the activations of the pool_3 layer of
                   the inception model.
        """
        act = self.get_activations(images, True)
